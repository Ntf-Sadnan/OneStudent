...
function App() {
  ...
  const features = [
    ...
    ["০ix", "কিউআর-সংযুক্ত বই", "বই স্ক্যান করেই সংশ্লিষ্ট ভিডিও পাঠ, ক্লাস অথবা পরীক্ষা শুরু।", "lavender"],
  ...
  return (
    <main id="top">
      ...
      <section className="learning section-pad" id="learning">
        <SectionTitle center eyebrow="শেখার মূল কেন্দ্র" title={<>Ultraconfident লার্নিং<br /><em>যা কিছু প্রয়োজন।</em></>} text="পাঠ্যক্রমের বিষয়বস্তু, বুদ্ধিদীপ্ত সহায়তা ও কার্যকর অনুশীলন — একটি সহজ অভিজ্ঞতায় সংযুক্ত।" />
      ...
      <section className="life section-pad">
        ...
        <div className="life-grid">
          <article className="life-card wellness"><img src={photos.wellness} alt="সুস্থতা নিয়ে সহায়ক আলোচনা" /><div><span>স্বাস্থ্য ও সুস্থতা</span><h3>সব দিক থেকে আরও শক্ত হও।</h3><p>মানসিক সুস্থতা, পুৃতি, চাপ ও স্বাস্থ্যকর পড়ার অভ্যাসে শিক্ষার্থী-নিরাপদ সহায়তা।</p><a href="#">সুস্থতা সহায়তা দেখুন <Arrow /></a></div></article>
      ...
      <section className="skills section-pad">
        ...
        <div className="skill-paths">
          <article className="skill-main">
            ...
            <div className="skill-overlay"><span>স্থানীয় দক্ষতা</span><h3>আধুনিক কৃষি ও খাদ্য উৎপাদন</h3><p>মাটি, বীজ, নিরাপদ চাষ ও বাজার সম্পর্কে প্রকল্পভিত্তিক শিক্ষা।</p><b>২৪টি ভিডিও · ৬টি প্রকল্প</b></div>
          </article>
      ...
      <footer>
        <div className="footer-main">
          ...
          <div className="footer-join"><b>সঙ্গে থাকুন</b><p>খ খবর, অগ্রগতি ও সুযোগের আপডেট পান।</p><div><input placeholder="আপনার ইমেইল ঠিকানা"/><button>→</button></div></div>
        </div>
